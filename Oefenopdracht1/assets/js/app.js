...
//initializeGame consists off two functions, the first function is randomizing the image to guess, the second one is randomizing the grid.
...
function initializeGame() {
 ...
 //imageClicked checks if the clicked image is the same image as the one to guess. Shuffles the images if that's the case. @param {event} event - The event that occurred
...
function clearImageGrid() {
 ...
 // Durstenfeld shuffle, cpu-optimized implementation of the Fisher-Yates shuffle. * @param {array} array - The array to be shuffled*/
function shuffleArray(array) {
 ...
 // Creates an image element out of the imageNames array and a given index. @param {integer} index - The index of the imageNames array
